                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  margin: EdgeInsets.fromLTRB(44.8, 0, 0, 19.4),
                                  child: Align(
                                    alignment: Alignment.topCenter,
                                    child: SizedBox(
                                      width: 130.8,
                                ...
                                Container(
                                  margin: EdgeInsets.fromLTRB(8.8, 0, 5.8, 14.8),
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Container(
                                                      margin: EdgeInsets.fromLTRB(0, 0, 11.6, 1),
                                                      child: Text(
                                                        '커피 14회',
                                                        style: GoogleFonts.getFont(
                                                          'Roboto Condensed',
                                      ...
                                      Container(
                                        margin: EdgeInsets.fromLTRB(0, 0, 17.1, 21),
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                      ...
                                      Container(
                                        margin: EdgeInsets.fromLTRB(5.5, 0, 5.5, 13),
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
